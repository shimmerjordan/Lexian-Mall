<template>
	<view>
		<!-- 地址 -->
		<navigator  :url="addressUrl + uid" class="address-section">
		...
		<view class="goods-section" v-for="(shop,index) in commodityList" :key="index">
			<view class="g-header b-b">
				<image class="logo" :src="shop.shopImg"></image>
				<text class="name">{{shop.shopName}}</text>
			</view>
			<!-- 商品列表 -->
			<view class="g-item" v-for="(item,idx) in shop.list" :key="idx">
